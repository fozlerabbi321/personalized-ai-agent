...
from app.agent.prompts import build_kairo_router_prompt
...
async def llm_decision_node(state: AgentState) -> dict:
    """
    Classify user career intent and set `state.intent`.
    ...
    router_prompt = build_kairo_router_prompt(messages)
